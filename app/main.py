...
class QRCodesView(BaseView):
    name = "QR Codes"
    icon = "fa-solid fa-qrcode"

    @expose("/qr-codes", methods=["GET"])
    async def qr_codes_page(self, request: Request):
        ...
        return await self.templates.TemplateResponse(
            ...
            {
                "museums": museums,
                "selected_museum": selected_museum,
                "exhibits": exhibits,
                "museum_id": museum_id,
                "title": "QR Codes",
                "subtitle": "Download QR codes for museums and exhibits",
            },
        )

    @expose("/qr-codes/{museum_id}/zip", methods=["GET"])
    async def qr_zip(self, request: Request):
        ...
        museum_id = request.path_params["museum_id"]
...
admin.add_base_view(QRCodesView)
